  ...
  */
  ...
  var swapContent = function (swap, container, transition, complete, triggerPageInit) {
    ...
    if (transition === 'fade') {
      ...
      var fadeContainerEnd = function () {
        ...
        if($.os.android && $.compareVersion("4.2.0", $.os.version)) {
          setTimeout(fadeSwapEnd, $.config.pushAnimationDuration);
        } else {
      ...
      if($.os.android && $.compareVersion("4.2.0", $.os.version)) {
        setTimeout(fadeContainerEnd, $.config.pushAnimationDuration);
      } else {
    ...
    if (/slide/.test(transition)) {
      ...
      swap.classList.remove(swapDirection);
      if($.os.android && $.compareVersion("4.2.0", $.os.version)) {
        setTimeout(slideEnd, $.config.pushAnimationDuration);
      } else {
